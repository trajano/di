...
async def test_autowired_with_container_and_function_scope_no_decorator():
    ...
    async with container:
        handler2 = await resolve_callable_dependencies(handler, container_scope_components=container._container_scope_components, definitions=container._definitions)
