...
class Context(Protocol[T_co]):
    ...
    async def get_optional_instance(self, typ: type[T]) -> T | None: ... # pragma: no cover
...
class ConfigurableContainer(Protocol):
    ...
    def add_component_implementation(self, implementation: object) -> None: ... # pragma: no cover
